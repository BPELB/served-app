...
const DARK_VARS  = { "--bg":"#100c0c","--bg2":"#180f0f","--bg3":"#1f1212","--bdr":"#3a1f1f","--text":"#ffffff","--muted":"rgba(255,255,255,0.55)","--hover":"#1e1212" };
const LIGHT_VARS = { "--bg":"#fdf4f4","--bg2":"#f7eaea","--bg3":"#f0e0e0","--bdr":"#d4b0b0","--text":"#1f0a0a","--muted":"rgba(31,10,10,0.5)","--hover":"#f0e4e4" };
...
const stC = s => s>=8?"#DC2626":s>=6?"#FF6B35":"#dc2626";
      ...
      <div style={{display:"flex",alignItems:"center",gap:14,padding:"14px 16px"}}
        ...
        <div style={{flex:1,minWidth:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6}}>
            <span style={{fontSize:12,fontWeight:700,color:b.open?"#DC2626":"#dc2626"}}>
              {b.open ? "Open" : "Closed"}
            </span>
            {b.hours && (
              <button
    ...
    <div style={{background:BG2,border:`2px solid ${BDR}`,borderRadius:18,padding:"14px 15px",marginBottom:10}}>
      ...
      <div style={{display:"flex",alignItems:"flex-start",gap:10,marginBottom:rated.length>0?10:0}}>
        ...
        <button onClick={()=>onHelpful(review.id)}
          ...
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{color:helped?"#DC2626":"#999"}}>
      ...
      <div style={{background:BG2,borderRadius:24,padding:24,maxWidth:360,width:"100%",
        ...
        <div style={{background:G,borderRadius:18,padding:22,marginBottom:18,textAlign:"center"}}>
          ...
          <div style={{background:"rgba(255,255,255,0.12)",borderRadius:14,padding:16,marginTop:14}}>
            ...
            <div style={{fontSize:32,color:"#DC2626",lineHeight:1,letterSpacing:2}}>
          ...
          <div style={{flex:1,minWidth:0}}>
            ...
            <div style={{display:"flex",gap:8,marginTop:4}}>
              ...
              <span style={{fontSize:11,fontWeight:700,
                color:(business.open||business.isOpen)?"#DC2626":"rgba(255,255,255,0.4)"}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:10}}>
          ...
          <div onClick={()=>setShowClaim(true)} style={{padding:"16px 18px",background:"transparent",
            ...
            <div style={{width:46,height:46,borderRadius:13,
              background:"linear-gradient(135deg,#DC2626,#b83e22)",
              boxShadow:"0 4px 12px rgba(224,85,53,0.35)",
          ...
          <div onClick={()=>onAdvertise()} style={{padding:"16px 18px",background:BG2,
            ...
            <div style={{width:46,height:46,borderRadius:13,
              background:O,
              boxShadow:"0 4px 12px rgba(224,85,53,0.3)",
              display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{flex:1}}>
              <div style={{fontSize:13,fontWeight:800,color:N}}>Advertise on franklyy</div>
            ...
            <button style={{padding:"8px 13px",borderRadius:10,
              ...
              boxShadow:"0 2px 8px rgba(224,85,53,0.3)",cursor:"pointer"}} onClick={()=>onAdvertise()}>Learn more →</button>
          </div>
        </div>
            ...
            {[["atmosphere","positive"],["food quality","positive"],["wait times","negative"],
              ...
              <div key={tag} style={{display:"flex",alignItems:"center",justifyContent:"space-between",
                ...
                <span style={{fontSize:11,fontWeight:700,padding:"2px 8px",borderRadius:8,
                  ...
                  color:sentiment==="positive"?"#DC2626":sentiment==="negative"?"#dc2626":"#ca8a04"}}>
                  {sentiment}
                </span>
              </div>
            ))}
